					...
					<div class="well">
						<div class="row-fluid">
							<div class="span12 post-title">
								...
								<p class="post-meta">发表于${post.postTime }</p>
							</div>
						</div>
						<!--post image-->
						<div class="row-fluid">
				...
				<div class="well">
					<div class="span12 commentsWrap">
						...
						<ul class="commentlist">
							<c:forEach items="${replyList}" var="item">
								<li class="comment even depth-1">
									...
									</div> <!--end top level comment body-->
								</li>
							</c:forEach>
						</ul>
						<!--end commentlist-->
						...
						<div id="respond">
							...
							<div class="row-fluid">
								<div class="span12">
									<form action="ReplyServlet?postID=${post.postID}" method="post"
										id="commentform" class="form-horizontal">
